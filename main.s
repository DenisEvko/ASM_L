...
main									; Основная подпрограмма
	...
	MOV32	R0, GPIOD_CRL				; адрес порта GPIOD_CRL	EQU	0x40011400
...
loop									; Бесконечный цикл
    MOV32	R0, GPIOD_BSRR				; адрес порта выходных сигналов //GPIOD_BSRR	EQU	0x40011410//

	MOV 	R1, #(PIN7)					; устанавливаем вывод в '1' //PIN7	EQU	0x00000080//
...
delay_loop
	SUBS	R0, #1						; SUB с установкой флагов результата //sсуффикс обновления флага Z (Set to 1 when the result of the operation is zero, cleared to 0 otherwise)
	IT 		NE
